...
# output location
output_path <- paste0(root_data_figs, script_output_ext, '_BGR_map/')
...
ggsave(plot = g_input, filename = paste0(output_path, 'bgr_map.png'), width = fig_width_wide, height = fig_height_wide)
