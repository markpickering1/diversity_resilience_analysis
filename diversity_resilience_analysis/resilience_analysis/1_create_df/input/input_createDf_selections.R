...
#####################################################
# all the following columns will be free of NAs - in theory the diversity metrics 
# are all already present, so don't need selection, but leave anyway
...
v_target <- c('kndvi_lambda_xt', 'kndvi_lambda_variance', 'kndvi_TAC', #)
              'kndvi_rob_lambda_xt', 'kndvi_rob_lambda_variance') # 'kndvi_lambda_xt') # , 'kndvi_lambda_variance')       #  ,'kndvi_TAC', , if this doesn't work in some scripts put only one until script updated
