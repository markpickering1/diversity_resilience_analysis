...
######     GLOBAL VARS                        #####
main_dir <- 'static_variables/socc/'
script_info <- '2_socc_tif_to_nc'              
script_info_input <- 'SOCC'
script_info_output <- 'SOCC_nc'   
file_name <- 'SOCC30cmRescaledAtModis' 
variable <- 'socc30m'
