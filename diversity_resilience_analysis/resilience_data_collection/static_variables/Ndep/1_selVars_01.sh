...
IN_DIR=${ROOT_DATA_INPUT}static_variables/Ndepo/raw_files/
TMP_DIR=${ROOT_DATA_INPUT}static_variables/Ndepo/multiyear_mean/tmp/
OUT_DIR=${ROOT_DATA_INPUT}static_variables/Ndepo/multiyear_mean/
...
TRG_FILE=${ROOT_DATA_INPUT}vegetation/8day/kNDVI/kNDVI_nc_merged_rescaled10_masked_01/merged_kndvi_2003_2021_rescaled10_masked50_01.nc
