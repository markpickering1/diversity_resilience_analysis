...
# 1) set working directories
in_dir=${ROOT_DATA_INPUT}static_variables/hansen/hansen_forest_cover_nc_masked/
in_grid_dir=static_variables/hansen/targetgrid/
out_dir=${ROOT_DATA_INPUT}static_variables/hansen/hansen_forest_cover_nc_masked_005/
in_file="hansenForestCoverNoLoss2000AtModisMean_masked50.nc"
