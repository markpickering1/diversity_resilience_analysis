# ########################################################
# Title         : 2_phenology_tif_to_nc.R
# Description   : Convert a given tif file to nc file
# Aims          : Convert the phenology tif in nc file
# Inputs	      : Phenology tif file
# Outputs	      : Phenology nc file
# Date          : 27/07/2023
# Version       : 3
...
script_info <- '2_phenology_tif_to_nc'              
script_info_input <- 'modis_phenology'
script_info_output <- 'modis_phenology_nc' 
#file_name <- 'modis_lcd_greenup_1_circular_mean' 
#file_name <- 'modis_lcd_dormancy_1_circular_mean'
file_name <- 'modis_lcd_length_1_mean'
#variable <- 'greenup_mean'
#variable <- 'dormancy_mean'
variable <- 'length_mean'
input_script_date <- '2023-07-27' 
