...
####################################################
## mask the rescaled kndvi time series with forest cover                                                                      
####################################################
...
# 1) set working directories
in_dir=${ROOT_DATA_INPUT}vegetation/8day/kNDVI/kNDVI_nc_merged_rescaled10/
in_mask_dir=${ROOT_DATA_INPUT}static_variables/hansen/hansen_forest_cover_nc_mask/
out_dir=${ROOT_DATA_INPUT}vegetation/8day/kNDVI/kNDVI_nc_merged_rescaled10_masked/
in_file="merged_kndvi_2003_2021_rescaled10.nc"
